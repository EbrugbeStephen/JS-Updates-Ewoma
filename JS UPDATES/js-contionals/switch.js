// The switch statement is used to perform differnt actions based on different conditions. Instead of using multiple else if statements you can simply use a switch statement.
...
If there is no match, the default code is executed.
